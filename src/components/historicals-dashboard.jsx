...
const HistoricalDashboard = ({ historicalData = [] }) => {
  ...
  const renderedInsights = useMemo(
    () =>
      insights.map((it, i) => (
        <li key={i} className="pb-2" style={{color:COLORS.secondaryText}}>
          {it}
        </li>
      )),
    [insights]
  ...
  return (
    <div className="bg-white p-4 rounded-[10px] border border-gray-200 mb-6">
      ...
      <div
        className={`p-2 rounded-md text-sm font-medium text-center mb-4 ${
          trendLabel.includes("Uptrend") ? "bg-green-100 text-green-700" : trendLabel.includes("Downtrend") ? "bg-red-100 text-red-700" : "bg-yellow-100 text-yellow-700"
        }`}
      >
      ...
      <div className="p-5 rounded-[10px] bg-white border" style={{borderColor:COLORS.border}}>
        <h3 className="text-xl font-semibold mb-3" style={{color:COLORS.titleText}}>📊 Insights</h3>
